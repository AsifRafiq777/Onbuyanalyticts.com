...
const HistoryItem: React.FC<HistoryItemProps> = ({ item, onLoad }) => {
  ...
  return (
    <li className={`flex justify-between items-center p-4 rounded-lg ring-1 ring-slate-200 hover:shadow-md transition-shadow duration-200 ${isProfit ? 'bg-green-50' : 'bg-red-50'}`}>
